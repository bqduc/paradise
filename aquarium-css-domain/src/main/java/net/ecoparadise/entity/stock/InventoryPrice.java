...
import net.ecoparadise.entity.DiscountOrExpense;
import net.ecoparadise.entity.Money;
import net.ecoparadise.entity.MoneySet;
import net.ecoparadise.entity.Quantity;
import net.ecoparadise.entity.UnitPriceMoneySet;
import net.ecoparadise.framework.entity.RepoAuditable;
import net.ecoparadise.framework.validation.StrictlyPositiveNumber;
import net.ecoparadise.model.UnitPriceScale;
