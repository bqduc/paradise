 ...
 * 
 */
package net.aquarium.comm.config;
...
import net.aquarium.comm.comp.EmailConfigurationHelper;
import net.aquarium.comm.exceptions.CommunicationException;
...
public class EmailConfiguration extends CompCore {
	...
	private JavaMailSender configEmailProfile() throws CommunicationException {
		...
		Optional<net.aquarium.entity.config.Configuration> optConfig = configurationService.getByName(GlobalConstants.CONFIG_ENTRY_NAME_EMAIL);
		Map<Object, Object> configDetailsMap = ListUtility.createMap();
		if (!optConfig.isPresent()) {
