 ...
 * 
 */
package net.ecoparadise.comm.config;
...
import net.ecoparadise.comm.comp.EmailConfigurationHelper;
import net.ecoparadise.comm.exceptions.CommunicationException;
import net.ecoparadise.common.ListUtility;
import net.ecoparadise.css.service.config.ConfigurationService;
import net.ecoparadise.exceptions.CryptographyException;
import net.ecoparadise.framework.component.CompCore;
...
public class EmailConfiguration extends CompCore {
	...
	private JavaMailSender configEmailProfile() throws CommunicationException {
		...
		Optional<net.ecoparadise.entity.config.Configuration> optConfig = configurationService.getByName(GlobalConstants.CONFIG_ENTRY_NAME_EMAIL);
		Map<Object, Object> configDetailsMap = ListUtility.createMap();
		if (!optConfig.isPresent()) {
