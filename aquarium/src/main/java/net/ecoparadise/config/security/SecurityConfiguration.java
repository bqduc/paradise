...
import net.ecoparadise.config.jwt.JwtSecurityConfigurer;
import net.ecoparadise.servlet.ServletConstants;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configureAppSecurity(HttpSecurity http) throws Exception {
      ...
      .authorizeRequests()
       	...
       	.anyRequest().access("@authorizationChecker.hasPermission(request, authentication)")
      .and()
      	.formLogin()
