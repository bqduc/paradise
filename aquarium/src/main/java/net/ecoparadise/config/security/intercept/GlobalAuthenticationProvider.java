package net.ecoparadise.config.security.intercept;
...
import net.ecoparadise.auth.intercept.CustomAuthenticationProvider;
...
@Named
@Component
public class GlobalAuthenticationProvider extends CompCore implements AuthenticationProvider {
	/**
	 * 
	 */
