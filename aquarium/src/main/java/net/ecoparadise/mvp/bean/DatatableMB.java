package net.ecoparadise.mvp.bean;
...
import net.ecoparadise.mvp.model.FacesCar;
import net.ecoparadise.mvp.model.FacesTeamFacade;
import net.ecoparadise.mvp.model.Stats;
import net.ecoparadise.mvp.service.FacesCarService;
