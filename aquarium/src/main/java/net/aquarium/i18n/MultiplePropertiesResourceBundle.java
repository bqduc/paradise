...
import net.aquarium.component.LocaleManager;
import net.aquarium.context.DatabaseMessageServiceImpl;
import net.aquarium.context.MessagePersistenceService;
