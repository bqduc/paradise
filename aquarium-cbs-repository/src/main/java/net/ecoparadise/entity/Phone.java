...
import net.ecoparadise.model.SystemConfiguration;
...
public class Phone implements Serializable {
    ...
    private void appendCountryCode(StringBuilder sb) {
    	if (!CommonUtility.isEmpty(countryCode)) sb.append("+").append(countryCode).append(" ");
    }
    
    private void appendAreaCode(StringBuilder sb) {
		if (!CommonUtility.isEmpty(areaCode)) sb.append("(").append(areaCode).append(") ");
    }

    private void appendExtension(StringBuilder sb) {
    	if(!CommonUtility.isEmpty(extention)) sb.append(" #").append(extention);
    }
