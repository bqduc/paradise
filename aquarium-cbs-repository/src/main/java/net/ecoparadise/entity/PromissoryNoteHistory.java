 ...
 */
@Entity
@Table(name="TRD_PROMISSORYNOTE_HISTORY")
public class PromissoryNoteHistory implements Serializable {
    ...
    @ForeignKey(name="FK_PROMISSORYHISTORY_WORKBUNCHID")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PromissoryNoteHistory)) {
            return false;
        }
        PromissoryNoteHistory other = (PromissoryNoteHistory)object;
