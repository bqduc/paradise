...
import net.aquarium.domain.RestErrorInfo;
import net.aquarium.domain.model.SearchCondition;
import net.aquarium.exceptions.EcosphereResourceException;
import net.aquarium.framework.service.IService;
