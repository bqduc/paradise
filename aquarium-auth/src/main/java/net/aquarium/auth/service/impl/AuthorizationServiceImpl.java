...
import net.aquarium.auth.core.AuthorizationServiceBase;
...
import net.aquarium.auth.service.AuthorizationService;
import net.aquarium.comm.comp.Communicator;
import net.aquarium.comm.domain.CorpMimeMessage;
import net.aquarium.comm.global.CommunicatorConstants;
